...
<title>Insert title here</title>
 <style>
  ...
  <section>
     <div id="main">
      ...
      <c:forEach items="${clist}" var="cvo">
       <c:if test="${cvo.state==0}">
           <tr align="center" onclick="viewform(this,${cvo.id})" class="tr">
       </c:if>
     ...
     <div id="vform">
       <form name="aform" method="post" action="acustom">
         <input type="hidden" name="cid"> <!-- custom테이블 id -->
